...
const TicketFrom = () => {
  ...
  const ticketSeat = (movieId, seatInfo) => {
    ...
    location.href = "/movie/seatSelection?theaterListId="+theaterListId+"&person=" + person +"_"+money;
  }
  ...
  return (
    <div>
      ...
      <div className="container-fluid p-0 d-flex">
        ...
        <div className="container p-0">
          <div className="row m-0 p-0 w-100 col-3 text-center">
            ...
            <div className="col-2 p-0 b-right">
              <div className="header"><h5>지역</h5></div>
              {/* 지역 스크롤 바 */}
              <div className="content p-0">
                <div className="scroll h-100 w-100 mt-3 mb-3">
                  <ul className="list-group" id='region-list'>
                    {/* 비동기 생성 */}
                  </ul>
                </div>
              </div>
            ...
            {/* 극장 */}
            <div className="col-2 p-0 b-right">
              <div className="header"><h5>극장</h5></div>
              {/* 극장 스크롤바 */}
              <div className="content">
                <div className="scroll mt-3 mb-3">
                  <ul className="list-group" id="theater-list">
                    {/* 비동기 생성 */}
                  </ul>
                </div>
              </div>
            ...
            {/* 날짜 */}
            <div className="col-2 p-0 b-right">
                <div className="header"><h5>날짜</h5></div>
                {/* 날짜 스크롤바 */}
                <div className="content">
                  <div className="scroll mt-3 mb-3">
                    <ul className="list-group" id="date-list">
                      {/* 비동기 생성 */}
                    </ul>
                  </div>
                </div>
            ...
            <div className="col-6 p-0">
                <div className="header"><h5>시간</h5></div>
                {/* 시간 스크롤바 */}
                <div className="content">
                  <div id="time-container" className="scroll mt-3 mb-3">
                    {/* 비동기 생성 */}
                  </div>
                </div>
            </div>
        ...
        <div className="heater flex-fill"></div>
      </div>
        ...
        <div className="container d-flex justify-content-between p-0" style={{height:"200px"}}>
          ...
          <div className="me-5">
            <div className="d-flex mb-2 align-items-center align-content-center">
              ...
              <span className='span1' id="adult" person="1">1</span>
              <button className="btn btn-secondary btnUp" onClick={aup}><i className="fa-solid fa-arrow-up"></i></button>
              <button className="btn btn-secondary btnDown" onClick={adown}><i className="fa-solid fa-arrow-down"></i></button>
            </div>
            <div className="d-flex align-items-center align-content-center">
              <p className="p-0 m-0">학생</p>
              <span className='span1' id="student" person="0">0</span>
              <button className="btn btn-secondary btnUp" onClick={sup}><i className="fa-solid fa-arrow-up"></i></button>
              <button className="btn btn-secondary btnDown" onClick={sdown}><i className="fa-solid fa-arrow-down"></i></button>
            </div>
          </div>
            <button className="btn reserve-btn" id="ticketSeat"><i className="fa-solid fa-angle-right fa-3x"></i><p>좌석선택</p></button>
          </div>
        </div>
      </div>
    </div>
